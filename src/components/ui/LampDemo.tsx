...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-start justify-center overflow-hidden dark:bg-neutral-950 w-full  z-0",
        className
      )}
    >
      <div className="absolute flex w-full flex-1 scale-y-125 items-start justify-center isolate z-0 ">
        <motion.div
