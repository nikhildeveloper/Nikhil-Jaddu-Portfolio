  ...
  return (
    <motion.div
      className="w-96 h-80 flex items-center justify-center 
                 opacity-100 sm:opacity-0 group-hover/pin:opacity-100 
                 z-[60] transition duration-500 resume-card" // ✅ Added class to track clicks
      onClick={(e) => {
        e.stopPropagation(); // ✅ Prevents immediate close after clicking the card
        setIsClicked(!isClicked);
      }}
    >
      {/* ✅ Mobile Version - Click to Reveal */}
      {isClicked && (
