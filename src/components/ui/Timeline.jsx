        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative w-full pl-20 pr-4 md:pl-4">
              <div className="glass-card p-6 rounded-2xl shadow-lg bg-opacity-50 border border-neutral-200 dark:border-neutral-800 bg-white/50 dark:bg-neutral-900/50 backdrop-blur-md">
                <div className="flex flex-col md:flex-row items-start gap-4">
                  {/* Left Column: Content */}
                  <div className="w-full md:w-2/3">
                    <h3 className="text-xl md:text-2xl font-bold text-neutral-800 dark:text-white mb-2">
                      {item.content.role}
                    </h3>
